...
class Contacts {
  ...
  static help () {
    console.log('insertContact(name, company_name, phone, email)')
    console.log('updateContact(id, name, company_name, phone, email)')
    console.log('deleteContacts(id)')
    console.log('showContacts()')
    console.log('showNameContacts(val)')
    console.log('searchContact(columnName, val)')
  }
